...
class KtMutableIteratorTest {

    @Test fun testKtMutableIterator() {
        val classUnderTest = KtMutableIterator(3)
    ...
    @Test fun testKtMutableIteratorMutability() {
        val classUnderTest = KtMutableIterator(3)
        val it = classUnderTest.iterator()
        assertTrue(it.hasNext(), "should have next")
        assertEquals(0, it.next(), "should be 0")
